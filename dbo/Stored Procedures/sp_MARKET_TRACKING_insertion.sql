CREATE procedure  [dbo].[sp_MARKET_TRACKING_insertion]
     ...
     (
        ...
        @TRACK_BR_ID,
        @TRACK_SCHOOL_NAME,
        @TRACK_SCHOOL_COUNTRY,
        @TRACK_SCHOOL_CITY,
        @TRACK_SCHOOL_AREA,
        @TRACK_SCHOOL_ADDRESS,
        @TRACK_SCHOOL_MOBILE_NO1,
        @TRACK_SCHOOL_MOBILE_NO2,
        @TRACK_SCHOOL_LANDLINE_NO,
        @TRACK_SCHOOL_EMAIL,
        @TRACK_SCHOOL_WEBSITE,
        @TRACK_CONTACT_NAME,
        @TRACK_CONTACT_DESIGNATION,
        @TRACK_CONTACT_MOBILE_NO,
        @TRACK_CONTACT_LANDLINE_NO,
        @TRACK_CONTACT_EMAIL,
        @TRACK_SALES_REPRESENTATIVE,
        @TRACK_REFFERED_BY,
        @TRACK_MARKETING_MODE_ID,
        @TRACK_STATUS
