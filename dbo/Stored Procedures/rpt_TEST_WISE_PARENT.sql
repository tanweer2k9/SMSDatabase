...
CREATE PROC [dbo].[rpt_TEST_WISE_PARENT] 
...
END
	...
	select distinct et.EXAM_TEST_ID [Test ID], sp.CLASS_Name [Class Name], sp.CLASS_ID,t.TERM_NAME Term, s.SUB_NAME as [Subject], et.EXAM_TEST_NAME Test,
...
--where sp.CLASS_SESSION_START_DATE = @SESSION_START_DATE and CLASS_SESSION_END_DATE = @SESSION_END_DATE
